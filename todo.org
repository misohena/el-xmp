...
* Inbox
** TODO image-diredでg gでフィルタを更新出来るようにする。
subjectを設定してからg gしてもフィルタが適用されていない？
...
** DONE subjectsをOR条件やEQUAL条件でフィルタ出来るようにする。
CLOSED: [2025-05-29 Thu 20:04]
まだsubjectsを設定していないもののみを表示したいが現在はそれができない。

argに文字列で "AND" "NOT AND" "OR" "NOT OR" "EQUAL" "NOT EQUAL" を指定出来るようにする。
